            ...
            return (
                ...
                <div className="Container" key={task.id}>
                    ...
                    {isViewMore === task.id ? <div>
                        ...
                        <Button variant="warning" size="sm" onClick={() => ViewLess()}> {isEdit === task.id ? "Cancel" : "View Less"}</Button>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                        {isEdit === task.id ?
                            <Button variant="warning" size="sm" onClick={() => saveTask(task)}>Save</Button> : ""}

                        {isEdit === task.id ? "" :
                            <Button variant="warning" size="sm" onClick={() => editTask(task)}>Edit</Button>}
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                        {isEdit === task.id ? "" :
                            <Button variant="warning" size="sm" onClick={() => deleteTask(task)}>Delete</Button>}

                    </div> :
                        <Button variant="warning" size="sm" onClick={() => ViewMore(task)}>View More</Button>}
